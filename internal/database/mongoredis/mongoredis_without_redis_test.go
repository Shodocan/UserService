...
func getConfigWithoutRedis(t *testing.T) *configs.EnvVarConfig {
	config, err := configs.GetEnvConfig()
	if err != nil {
		t.Errorf("Error trying to get config %v", err)
		t.Fail()
	}
	config.RedisDBHost = "127.0.10.5"
	config.RedisDBPassword = "123123123"
	return config
}

func TestMongoConnectWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
	mongo, err := NewDB(getConfigWithoutRedis(t), configs.NewLog())
...
func TestPingWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
...
func TestCreateWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
...
func TestFindWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
...
func TestUpdateWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
...
func TestDeleteWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
...
func TestQueryWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
	...
	res := []TestEntity{}
	err = mongo.Query("teste", bson.M{}, bson.M{}, 0, 10, &res)
...
func TestTotalWithoutRedis(t *testing.T) {
	if !checkMongo() {
		t.Skip()
		return
	}
